        ...
        <div className="max-w-[1000px] w-full border border-white/[0.06] h-fit animate-page-enter">
            ...
            {[
              {
                ...
                content: (
                  <p>
                    SolPay is currently in <strong className="text-text-primary">beta</strong>. The platform is provided on an
              ...
              },
              {
                ...
                content: (
                  <>
                    <p>
                      To the fullest extent permitted by applicable law, SolPay and its operators shall not be liable for any
                    ...
                    <p className="mt-3">
                      You acknowledge that you use SolPay entirely at your own risk. We are not responsible for any financial
              ...
              },
              {
                ...
                content: (
                  <>
                    <p>
                      SolPay is <strong className="text-text-primary">not available</strong> to users located in, incorporated in,
                    ...
                    <p className="mt-3">
                      By using SolPay, you represent and warrant that you are not subject to the laws of any restricted
              ...
              },
              {
                ...
                content: (
                  <>
                    ...
                    <p className="mt-3">
                      SolPay does not custody your funds. Payments are processed through temporary escrow addresses and swept to
              ...
              },
              {
                ...
                content: (
                  <p>
                    SolPay charges a 1% platform fee on confirmed payments, deducted during the sweep process. Withdrawals
              ...
              },
              {
                ...
                content: (
                  <p>
                    We reserve the right to suspend or terminate access to SolPay at any time, for any reason, without prior
              ...
              },
              {
                ...
                content: (
                  <p>
                    We may update these Terms of Service at any time. Continued use of SolPay after changes constitutes
          ...
          <div className="px-6 sm:px-10 py-6 border-t border-white/[0.06] bg-white/[0.01]">
            <p className="text-text-tertiary text-[11px]">
              By connecting your wallet and using SolPay, you acknowledge that you have read, understood, and agree to
